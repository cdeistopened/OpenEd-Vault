---
title: "OpenEd Day in the Life: Brettani Shannon’s Slow-Morning, AI-Powered, Unit Studies Curriculum"
url: https://opened.co/blog/opened-day-in-the-life-brettani-shannons-slow-morning-ai-powered-unit-studies-curriculum
slug: opened-day-in-the-life-brettani-shannons-slow-morning-ai-powered-unit-studies-curriculum
type: blog
date: 2025-12-09
meta_description: ""
summary: "A peek into one family’s intentional Open Education homeschool: 10 a.m. starts, AI-built unit studies, a flexible tech stack, and real-life learning."
webflow_id: 69385585150cb2dd62517ca5
last_synced: 2025-12-17 21:56
---

# OpenEd Day in the Life: Brettani Shannon’s Slow-Morning, AI-Powered, Unit Studies Curriculum

**URL:** [https://opened.co/blog/opened-day-in-the-life-brettani-shannons-slow-morning-ai-powered-unit-studies-curriculum](https://opened.co/blog/opened-day-in-the-life-brettani-shannons-slow-morning-ai-powered-unit-studies-curriculum)
**Type:** blog
**Published:** 2025-12-09

## Summary
A peek into one family’s intentional Open Education homeschool: 10 a.m. starts, AI-built unit studies, a flexible tech stack, and real-life learning.
...
This isn't a compromise. It's [Open Education](https://opened.co/open-education)—and it's completely intentional.
...
This is where [OpenEd](https://opened.co/) changes the game. The financial support lets me say "Yes" to the things I can't do myself.

- **Math:** We tried [*Teaching Textbooks*](https://www.teachingtextbooks.com/) (great, cheap, and no effort for parent, but got boring) and [*Beast Academy*](https://beastacademy.com/) (Snow hated the videos, I hated the workbooks). Now, we use [**Synthesis**](https://www.synthesis.com/) for the basics, which she enjoys because they truly harness the power of choice. We play math games (such as pet adoption), do oral quizzes in the car, and reinforce with the occasional lesson from Math-U-See and Khan Academy when there is a topic she is struggling with.
- **Writing:** We are using [*Write Shop*](https://writeshop.com/) curriculum this year. It has helped me to have a flow: learn skills through activities and games, prewriting skills, writing and editing process that is a collaborative effort, leaning into my skills as a writer without me seeming too critical.
...
- [**Perplexity AI**](https://www.perplexity.ai/): The engine for creating custom Unit Studies (book lists, schedules, project ideas).
- [**Google Sheets/Calendar**](https://workspace.google.com/): The central nervous system. Used to map out the year, track OpenEd funding/classes, and visualize "blackout dates" for dance/travel.

## **Core Curriculum**

- **Math:**[**Synthesis**](https://www.synthesis.com/): For mental math and math facts (Gamified, high-agency).
- [**Life of Fred**](https://lifeoffred.uniquemath.com/): Narrative-based math books.
- [**Teaching Textbooks**](https://www.teachingtextbooks.com/): (Used previously, loved the independence but got repetitive).
- [**Rescue Me**](https://mathgames.org/library/rescue-me/): Math game focused on teaching division.

**Language Arts:**
- [**Write Shop**](https://writeshop.com/): Writing curriculum (Parent-guided).
- [**Keyboarding Without Tears**](https://www.lwtears.com/): Typing practice (Free resources available).

**Spanish:**
- [**Ready for Spanish**](https://www.readyforspanish.com/): Homeschool-specific Spanish program (video lessons, cultural activities).

## **Unit Studies (Science/History/Culture)**

- [**Campfire Curriculums**](https://campfirecurriculums.com/): Pre-made topical unit studies (open-and-go, multi-subject, beautifully written, family style).
- **Custom AI Units:** Created via Perplexity (Topics: Pet Adoption, Selena/Hispanic Heritage, Veterans Day).

## **Enrichment & "The Village"**

- **OpenEd Classes:** Uses funding for:In-person Art/Science Classes
