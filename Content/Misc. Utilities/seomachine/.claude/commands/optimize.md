...
1. Search `context/blog-index.csv` for relevant topics:
   ```bash
   grep -i "keyword" seomachine/context/blog-index.csv
   ```
2. Browse `context/internal-links-reference.md` for curated list with descriptions
3. Prioritize: podcasts > blog posts > daily newsletters
