---
Tools: "- Habitica: A tool to gamify tasks and routines.- Visual timers: Helps with time management for ADHD students.- Post-it systems: Better for working memory than digital planners.- Fidgets: Tools like fidget spinners or squeeze balls to aid focus.- Khan Academy: An online resource for math learning.- Teaching Textbooks: Another resource for math.- Math-U-See: A math program suitable for ADHD learners.- Audiobooks: Paired with physical books for reading comprehension."
Tweetables]: "- https://opened.co/blog/episode-019-qa-adhd-social-skills-making-hard-choices-in-alternative-education- https://www.adhdessentials.com/- https://www.khanacademy.org/- https://www.teachingtextbooks.com/- https://mathusee.com/- https://habitica.com/static/home- https://opened.co/"
Breakdown: "- Thoughts:- Quote about judging abilities (fish and tree analogy) is often misinterpreted.- Importance of reaching societal expectations despite differences in abilities.- Personal experience with ADHD diagnosis later in life.- Understanding different presentations of ADHD in children.- Tools:- Understanding the ADHD brain:- ADHD is not a deficit of attention but a lack of control over it.- Executive function is impacted, leading to developmental delays.- The 30% Rule: ADHD individuals function about 30% behind their peers in executive function.- The Wall of Awful: Emotional barriers to starting tasks due to past failures.- Trends:- Need for scaffolding in education longer than commonly expected.- Importance of interest-based engagement rather than just importance-based motivation.- Flexibility in homeschooling allows for changing curriculum based on effectiveness.- Strategies:- Build external support systems (fishbowl analogy).- Adjust expectations based on executive function rather than chronological age.- Simplify tasks and reduce visual clutter.- Advocate for necessary accommodations without stigma.- Use engaging, hands-on, and novelty-driven curriculum.- Tools and resources: visual timers, fidget tools, body doubling, audiobooks, and gamified learning."
Created time: 2025-10-30T11:50
Weekly?: false
Date: 2025-10-29
URL: https://opened.co/blog/homeschooling-a-child-with-adhd
Best of: false
Meta Description: Homeschooling a child with ADHD can be rewarding. Learn effective strategies tailored to your child's unique brain, ensuring they thrive in a supportive environment.
Best Quotes: 1. "Everyone is a genius, but if you judge a fish on its ability to climb a tree, it will live its whole life believing it is stupid."2. "Let us be fish because that's where we thrive. But please don't tell us we don't have to reach the top of the tree. We do."3. "ADHD doesn't impact intelligence at all... you can get a 36 on the ACT and still do stupid things."4. "When Alex was first diagnosed, no one explained the developmental delay in executive function for people with ADHD—about 30 percent behind their peers."5. "Every time your ADHD student tries to do something and fails, that failure gets added to an emotional wall they have to climb over before they can even start the task again."6. "Accommodations aren't cheating. They're leveling the playing field."7. "Don't judge the fish on its ability to climb. Build the fish a fishbowl, and carry that fish to the top of the tree yourself."
keep: false
Orgs mentioned: OpenEd, ADHD Essentials, Khan Academy, Teaching Textbooks
Status: Not started
Text: https://opened.co/blog/episode-019-qa-adhd-social-skills-making-hard-choices-in-alternative-educationhttps://www.adhdessentials.com/https://www.youtube.com/watch?v=Uo08uS904Rghttps://habitica.com/static/homehttps://www.youtube.com/channel/UCuiF-_3Cj51fQeIJ9IliMbg?ybp=-gEVMTQyNDM2MjYtT3BlbkVkIERhaWx5https://www.khanacademy.org/https://www.teachingtextbooks.com/https://mathusee.com/http://opened.co/
---
[![](https://cdn.prod.website-files.com/67e31168e49f5b7e6f76f0e5/690213d2d6ed7474d8b24b5e_Gemini_Generated_Image_rb37tkrb37tkrb37.png)](https://cdn.prod.website-files.com/67e31168e49f5b7e6f76f0e5/690213d2d6ed7474d8b24b5e_Gemini_Generated_Image_rb37tkrb37tkrb37.png)

_==For more on this topic,==_ _==[listen to our podcast episode](https://opened.co/blog/episode-019-qa-adhd-social-skills-making-hard-choices-in-alternative-education)====.==_

==‍==

==There's a quote that often circulates in special education settings:==

_=="Everyone is a genius, but if you judge a fish on its ability to climb a tree, it will live its whole life believing it is stupid."==_
...
==It turns out, however, that Dylan== _==does==_ ==have ADHD—just a very different presentation. Understanding these different presentations—and the underlying neurology—completely changed how I approached parenting and teaching my sons.==
...
==People with ADHD actually do not have a deficit of attention. They have attention to spare. What they lack is== _==control==_ ==over what gets that attention. It's like having 50 channels on the television, and someone else controls the remote.==
...
==**[Listen to Andrea's podcast episode on ADHD](https://opened.co/blog/episode-019-qa-adhd-social-skills-making-hard-choices-in-alternative-education)**==
...
==So why was I expecting these things from my teenager with ADHD? This doesn't mean lowering expectations for learning. Alex is brilliant. He can handle advanced coursework. But it does mean adjusting expectations for== _==managing==_ ==that learning.==
...
==Brendan Mahan of== ==[ADHD Essentials](https://www.adhdessentials.com/)== ==calls this "====[The Wall of Awful."](https://www.youtube.com/watch?v=Uo08uS904Rg)== ==For neurotypical people, starting an unpleasant task might feel like stepping over a small curb. For people with ADHD, it feels like scaling a 40-foot wall—a wall built from every past failure, criticism, and time they disappointed someone.==
...
==I'm going to tell you something that might surprise you: you don't need special ADHD curriculum. You need curriculum that's== _==actually engaging==_==.==
...
==Your kid hates the math curriculum? Switch it. Try== ==[Khan Academy](https://www.khanacademy.org/)====. Try== ==[Teaching Textbooks](https://www.teachingtextbooks.com/)====. Try writing math problems about Pokémon. In traditional school, this flexibility doesn't exist. In homeschooling, it's your superpower.==
...
- ==**For gamifying learning:**== ==[Habitica](https://habitica.com/static/home)== ==is my favorite tool to help gamify tasks and routines. It turns your to-do list into a role-playing game where you can level up and earn rewards, providing the novelty and challenge that ADHD brains need.==
- ==**For time management:**== ==[Visual timers](https://www.youtube.com/channel/UCuiF-_3Cj51fQeIJ9IliMbg?ybp=-gEVMTQyNDM2MjYtT3BlbkVkIERhaWx5)== ==(the kind where students can see time passing) help with time blindness. ADHD students have no internal sense of time, so they need external cues.==
...
- ==**For math:**== ==[Khan Academy](https://www.khanacademy.org/)====,== ==[Teaching Textbooks](https://www.teachingtextbooks.com/)====,== ==[Math-U-See](https://mathusee.com/)====, or even creating custom word problems about their special interests.==
...
==This flexibility is exactly what== ==[OpenEd](https://opened.co/)== ==was designed to enable. As an OpenEd family, you have:==
...
_==For more resources on homeschooling with ADHD, visit==_ _==[OpenEd.co](http://opened.co/)==_ _==or listen to our==_ _==[full podcast series on ADHD and open education](https://opened.co/blog/episode-019-qa-adhd-social-skills-making-hard-choices-in-alternative-education)====.==_