---
title: "Best Homeschool Math Curriculum"
url: https://opened.co/blog/best-homeschool-math-curriculum
slug: best-homeschool-math-curriculum
type: blog
date: 2025-11-05
meta_description: ""
summary: "Not a “math person”? Discover the best homeschool math curriculum for every learning style—mastery, visual, and adaptive."
webflow_id: 690bc27ad10a25559d1afd14
last_synced: 2026-01-02 20:56
---

# Best Homeschool Math Curriculum

**URL:** [https://opened.co/blog/best-homeschool-math-curriculum](https://opened.co/blog/best-homeschool-math-curriculum)
**Type:** blog
**Published:** 2025-11-05

## Summary
Not a “math person”? Discover the best homeschool math curriculum for every learning style—mastery, visual, and adaptive.

## Content

Laura Feller, a mom using OpenEd in Utah, made a confession on [the OpenEd Podcast](https://youtu.be/1zfEhRJq_sI?si=lFFSB8w9KZTKcl1z): "Math is not my strong suit. It is where I struggled most in school."
...
Then she found [Math-U-See](https://www.mathusee.com/).
...
According to Shalinee Sharma, founder of [Zearn](https://www.zearn.org/) and author of [*Math Mind: The Simple Path to Loving Math,*](https://about.zearn.org/math-mind-book) "All humans have an inherent number sense and ability to think mathematically. [Babies only a few days old can distinguish between two and three](https://www.scientificamerican.com/article/babies-are-born-with-an-innate-number-sense/)."
...
In the early days of [OpenEd](https://opened.co/), founder Matt Bowman and his wife Amy surveyed 92 families with what seemed like a simple question: "What is your favorite core curriculum for math, English, history, and science?"
...
Programs like [Saxon Math](https://www.hmhco.com/programs/saxon-math), [Math-U-See](https://www.mathusee.com/), and [Math Mammoth](https://www.mathmammoth.com/) exemplify this approach.

**Conceptual/Visual Programs** prioritize understanding the *why* behind math before the *how*. [Singapore Math](https://www.singaporemath.com/) uses bar models to make fraction relationships visible. [Beast Academy](https://beastacademy.com/) turns multiplication into puzzles where the operation is the key to solving, not just the assignment. [RightStart Mathematics](https://rightstartmath.com/) builds number sense through hands-on manipulation, and the puzzle-based [ST Math](https://www.stmath.com/) teaches concepts visually without words.
...
**Spiral/Incremental Programs** touch multiple concepts and return to them repeatedly in deeper ways over time. This is the model used by programs like [Horizons Math](https://aop.com/products/horizons-math-box-set-jmc100?_pos=1&_sid=95c6ecad1&_ss=r), which builds connections by seeing how addition relates to multiplication relates to fractions relates to algebra. Great for kids who like variety, but can leave gaps if a child doesn't master something before moving on.

These three approaches aren't mutually exclusive—they're different tools for different learning styles. Your visual learner might thrive with [Singapore Math](https://www.singaporemath.com/) but prefer [IXL](https://www.ixl.com/) for practice. Your mastery-focused kid might need [Saxon](https://www.hmhco.com/programs/saxon-math) for structure but supplement with [Beast Academy](https://beastacademy.com/) for problem-solving.

You can switch mid-year. Math is unusually modular—if [Teaching Textbooks](https://www.teachingtextbooks.com/) isn't working in October, you can switch in November without destroying continuity.

## Kindergarten Homeschool Math Curriculum

Your kindergartener's brain processes math through visuospatial working memory. [Dr. Claire Honeycutt](https://x.com/HippyMomPhD), a neuroscience researcher who left her tenured position at Arizona State University to homeschool her own children, identifies two key components: **visuospatial manipulation** (recognizing and mentally rotating patterns and images) and **spatial sequencing** (keeping steps and locations in order). Dr. Honeycutt shares her research and homeschooling insights at [ClarifiEd](https://www.clarified.life/).
...
**If you want formal curricula**, the programs from the three philosophical camps all have kindergarten levels. [RightStart](https://rightstartmath.com/) Level A uses manipulatives heavily. [Math-U-See Primer](https://mathusee.com/products/math-u-see-curriculum/primer/) provides video-based instruction. [Singapore Math Kindergarten](https://www.singaporemath.com/) takes a visual, concrete approach. For a gamified, app-based approach, many families also use [Math Seeds](https://mathseeds.com/) for this age.
...
**The programs from the three philosophical camps continue through elementary** ([Singapore](https://www.singaporemath.com/), [Math-U-See](https://www.mathusee.com/), [Saxon](https://www.hmhco.com/programs/saxon-math), [Beast Academy](https://beastacademy.com/), [RightStart](https://rightstartmath.com/)). Choose based on your child's learning style and your family's needs, not on which program is "best."

Remember the triplets? This is where their paths diverged. Jane and Jackie thrived with the mastery-based approach of [Math-U-See](https://www.mathusee.com/)—they needed to own one concept completely before moving on. Julia, however, hated this. She needed variety, multiple concepts at once. Same mom, same family, completely different architecture needed.
...
[**Zearn (K-5)**](https://www.zearn.org/) — Free digital lessons serving 1 in 4 elementary students. "If a student gets stuck, the lessons adapt... helping them visualize it," Sharma explains. A RAND Corporation study of 10,000+ students showed students using Zearn gained 11 additional weeks of math learning per school year. Strong research backing.

[**DreamBox**](https://www.dreambox.com/) — Intelligent adaptive learning that adjusts to student in real-time. DreamBox analyzes 48,000 data points per hour per student. Research shows students completing 5+ lessons weekly (one hour/week) averaged 30 points more growth than non-users.

[**Prodigy Math**](https://www.prodigygame.com/) — Gamified practice with 100+ million registered users battling through fantasy world. The free version includes all curriculum, but the freemium model creates two tiers of students with premium members ($75-360/year) visibly distinguished through exclusive pets and member badges.

[**IXL**](https://www.ixl.com/) — Comprehensive platform with strong research backing (Johns Hopkins study shows effectiveness, especially for Hispanic students, special education, and ELL students). However, student reviews reveal significant anxiety issues. The SmartScore algorithm drops 5-20 points for one wrong answer while adding only 1-3 points for correct answers. Multiple reviews report students "came up to me crying" and being "sent to guidance because IXL is so frustrating." Choose carefully based on child's temperament—high risk for anxiety-prone students despite strong effectiveness data.

[**Imagine Math**](https://www.imaginelearning.com/products/math/math/) — Personalized pathways with bilingual support and live tutoring. Particularly effective for students furthest below grade level.
...
**The core programs continue** ([Saxon](https://www.hmhco.com/programs/saxon-math), [Math-U-See](https://www.mathusee.com/), [Singapore](https://www.singaporemath.com/) all have middle school levels). But new options become relevant:

**For Independence:**

[Teaching Textbooks](https://www.teachingtextbooks.com/) becomes more appealing here. Automated grading, video explanations, less parent involvement needed. It may not be rigorous enough for gifted math students, but for average students needing confidence or busy parents managing multiple children, it can be liberating. Video-based programs like [CTC Math](https://ctcmath.com/) also cover all grade levels (K-12) in one family subscription, allowing students to work independently.

**For Challenge-Hungry Kids:**

[**Art of Problem Solving (AoPS)**](https://artofproblemsolving.com/) — Problem-solving over procedure. Community of mathematically curious kids. Rigorous, proof-based. Not for everyone, but life-changing for the right student. Since 2015, all USA International Math Olympiad team members have been AoPS students. In 2024, Team USA won first place—all six members AoPS alumni. But AoPS itself warns: students accustomed to 100% accuracy may start answering just 50-60% correctly. This is where you go if your kid is bored by traditional approaches.

**AI-Adaptive Platforms:**

These create custom learning paths, adapting in real-time:

[**Math Academy**](https://www.mathacademy.com/) — AI-powered adaptive learning from elementary through calculus. Uses spaced repetition and mastery-based progression. Internal data claims students progress "4x faster" with some completing calculus in under a year from 6th grade math. However, no formal peer-reviewed studies found—effectiveness claims rest on internal data. Math educators note it "overstates value of procedural fluency" and may not expose weak conceptual understanding until too late. Best as supplement to conceptual resources rather than standalone curriculum.

[**Aleks**](https://www.aleks.com/) — AI assessment creates custom path based on knowledge gaps. When ALEKS determines a student is ready to learn a concept, they master it 90-95% of the time—the highest success rate reported. Works well for filling specific holes in understanding.

[**Khan Academy**](https://www.khanacademy.org/) — Free, comprehensive. Adaptive practice with instant feedback. Good for review, filling gaps, extra practice. The key metric: 30+ minutes per week leads to 20% greater-than-expected learning gains.
...
When we [spoke with Laura Feller on the OpenEd Podcast](https://youtu.be/1zfEhRJq_sI?si=lFFSB8w9KZTKcl1z), her youngest was working through algebra. She explained that [Math-U-See](https://www.mathusee.com/) goes all the way through calculus—a course she'd never taken and never planned to. "My youngest son may get to calculus," she said, "and this curriculum will help him do that because I certainly won't be able to."
...
**The core programs continue through high school** ([Saxon Advanced Mathematics](https://www.hmhco.com/programs/saxon-math), [Math-U-See](https://mathusee.com/) through Calculus, [Art of Problem Solving](https://artofproblemsolving.com/) Algebra through Calculus, [Teaching Textbooks](https://www.teachingtextbooks.com/) through Precalculus).

**What's new at this level:**

**Specialized Programs:**

[**VideoText Algebra**](https://www.videotext.com/) — Particularly strong for algebra specifically.

[**Thinkwell**](https://www.thinkwell.com/) — Video-based, college-prep focused. Professor-led lectures.

[**Jacobs Geometry**](https://www.masterbooks.com/jacobs-geometry) — Proof-focused, challenging. Excellent for students who struggled with algebra but excel at geometry—they can see the relationships.
...
**Online High School Courses** — [Derek Owens](https://www.derekowens.com/), [Outlier.org](https://www.outlier.org/)
...
Starting at kindergarten level on [Khan Academy](https://www.khanacademy.org/), spending just 1-2 hours a day, this teenager who "hated math" caught up to grade level in less than three months.
...
[* ****Khan Academy***](https://www.khanacademy.org/)*** (K-12)**** — Comprehensive video lessons and practice problems. Weakness: pure lecture format, no physical textbook. Best use: supplement for practice, review, filling gaps. Can work as core for motivated, independent learners.*



[**Zearn**](https://www.zearn.org/)** (K-8)** — "Teachers and families can access our full library of digital math lessons for free," Sharma explains. Serves 1 in 4 elementary students and over 1 million middle schoolers. Designed by teachers, research-backed.

[**CK-12 Foundation**](https://www.ck12.org/) — Free textbooks, adaptive practice. Comprehensive K-12.

[**Math is Fun**](https://www.mathsisfun.com/) — Explanations, worksheets. Good for reference.

**YouTube Channels:**

- [**Professor Leonard**](https://www.youtube.com/@ProfessorLeonard) — College-level math explained clearly (Calculus, Statistics, Precalculus)
- [**3Blue1Brown**](https://www.youtube.com/@3blue1brown) — Visual, intuitive explanations of higher math concepts
- [**PatrickJMT**](https://www.youtube.com/@patrickjmt) — Clear, concise math tutorials covering algebra through calculus
- [**The Organic Chemistry Tutor**](https://www.youtube.com/@TheOrganicChemistryTutor) — Comprehensive tutorials for high school and college math

**The Trade-Off:** Free often means you do more curation work. Not worse—just different architectural challenge. Many families use [Khan Academy](https://www.khanacademy.org/) plus [Singapore](https://www.singaporemath.com/) workbooks, or [Zearn](https://www.zearn.org/) plus supplemental problem-solving from other sources.

**When to Invest:** When free isn't clicking. When parent support/structure matters. When you need phone support (Laura's [Math-U-See](https://mathusee.com/) experience).

## Tips for Homeschooling Math

### The Architect's Toolkit: 5 Core Strategies

**1. Make abstract concepts visual.** Use manipulatives even in upper grades and bar modeling for word problems (a core of the [Singapore Math](https://www.singaporemath.com/) approach). As Shalinee Sharma notes, "Understanding lies in bridging abstract concepts to the concrete and physical world." Consider fractions: Is 1/3 or 1/4 larger? Cut a cake into thirds and fourths. It becomes intuitive—especially for a kid.

**2. You're allowed to switch and mix.** Math is modular—if [Teaching Textbooks](https://www.teachingtextbooks.com/) isn't working in October, switch in November. Different kids in the same family can use different programs (remember the triplets). You can even use different programs for different topics: [Singapore](https://www.singaporemath.com/) for conceptual understanding plus [Saxon](https://www.hmhco.com/programs/saxon-math) for practice, or [Beast Academy](https://beastacademy.com/) for problem-solving plus [Khan Academy](https://www.khanacademy.org/) for fluency.

**3. Make facts automatic through play.** Math facts need to be automatic, but skip the worksheets. Board games ([Battleship](https://a.co/d/h7Dppg9) for coordinates), card games ([multiplication war](https://a.co/d/cgXwurg)), and apps like [Prodigy](https://www.prodigygame.com/main-en) or [DreamBox](https://www.dreambox.com/) all work. Shalinee Sharma explains that "purposeful practice builds fluency, making basic math processes automatic and freeing mental capacity for complex problem-solving."

**4. Leverage AI strategically.** Platforms like [Zearn](https://www.zearn.org/), [DreamBox](https://www.dreambox.com/), and [Aleks](https://www.aleks.com/?_s=3595466162593171) adapt in real-time to student performance, freeing up parent time. Tools like [Khan Academy](https://www.khanacademy.org/) and [Synthesis Tutor](https://www.synthesis.com/tutor) don't just give answers—they walk through reasoning. Use these to supplement curriculum, not replace human connection.
...
- Access any secular math curriculum ([Singapore](https://www.singaporemath.com/), [Math-U-See](https://www.mathusee.com/), [Saxon](https://www.hmhco.com/programs/saxon-math), [Beast Academy](https://beastacademy.com/), [RightStart](https://rightstartmath.com/), [Art of Problem Solving](https://artofproblemsolving.com/), [Math Mammoth](https://www.mathmammoth.com/), and more)
- Use adaptive platforms ([Zearn](https://www.zearn.org/), [DreamBox](https://www.dreambox.com/), [Aleks](https://www.aleks.com/), [IXL](https://www.ixl.com/), [Math Academy](https://www.mathacademy.com/))
- Access specialized programs ([VideoText](https://videotext.com/), [Thinkwell](https://www.thinkwell.com/), [Teaching Textbooks](https://www.teachingtextbooks.com/), [CTC Math](https://ctcmath.com/))
...
[Apply for OpenEd](https://opened.co/apply) | [Explore Math Resources](https://opened.co/marketplace) | [Read Open Education Book](https://opened.co/book)
