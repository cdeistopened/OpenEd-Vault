---
title: "Who is your child’s best teacher?"
url: https://opened.co/blog/who-is-your-childs-best-teacher
slug: who-is-your-childs-best-teacher
type: blog
date: 2025-09-10
meta_description: ""
summary: "Yes, you are qualified to teach your kids. How modern homeschoolers are redefining the parent’s role in education."
webflow_id: 68c208a08a1991f935c853fb
last_synced: 2026-01-02 20:56
---

# Who is your child’s best teacher?

**URL:** [https://opened.co/blog/who-is-your-childs-best-teacher](https://opened.co/blog/who-is-your-childs-best-teacher)
**Type:** blog
**Published:** 2025-09-10

## Summary
Yes, you are qualified to teach your kids. How modern homeschoolers are redefining the parent’s role in education.

## Content

"I'm not a teacher. How can I possibly homeschool my kids?"
...
Even so, homeschooled students [consistently score higher on standardized academic tests](https://nheri.org/academic-achievement-and-demographic-traits-of-homeschool-students-a-nationwide-study-2010/).
...
2. Embracing learning *alongside* your children
3. Knowing how to leverage the resources now available to parents
...
It's also worth noting that the landscape of home-based education has expanded beyond traditional homeschooling. [OpenEd,](https://opened.co/) for example, partners with public schools to offer a program where certified teachers provide oversight while parents facilitate at home, on the road, or abroad (really, anywhere with an internet connection). Technically, families enrolled in OpenEd and similar programs aren't "homeschoolers" but rather *distance learning students*.
...
In his book, [*Open Education: How to Reimagine Learning, Ignite Curiosity, and Prepare Your Kids for Success*](https://a.co/d/5SZBVOO)*,* Bowman advocates for what an approach where parents act more as architects than instructors; curators rather than subject experts.
...
Corey DeAngelis, author of [*The Parent Revolution*](https://a.co/d/8TRZSu9), also questions the assumption that homeschooling requires specialized knowledge delivery:
...
[Meg Thomas](https://www.coachmegthomas.com/), a homeschool coach with 18 years of experience and seven children, [shared her refreshingly honest perspective on the OpenEd podcast](https://opened.co/blog/meg-thomass-3-part-framework-for-calm-homeschooling): "I never learned how to diagram sentences. I couldn't have told you what an adverb was. A lot of the times when I was teaching my kids, I was learning it for the very first time."
...
When OpenEd CEO Isaac Morehouse interviewed Amir Nathoo, CEO of [Outschool](http://outschool.com), they discovered they'd both faced the exact same challenge: [helping their sons learn Minecraft modding](https://youtu.be/ASuPwY3PSR0?si=2FjoX4mITM_69Iqp).
...
"I found [a class on Outschool](https://outschool.com/classes/modding-with-minecraft-live-group-course-beginner-xiE0ykkw)," Isaac explained. "After six weeks, my son was showing me custom blocks he'd created."
...
[Laura Feller, a homeschool parent featured on the OpenEd podcast](https://youtu.be/1zfEhRJq_sI?si=4wzWj8Kus37Tx4Ki), had worried that her teenager would never advance past the level she had achieved as a student who struggled with math. However, she found her solution in [Math-U-See](https://mathusee.com/). The curriculum came with comprehensive video lessons for every concept, and when she needed extra help, their support line provided real human assistance. "My youngest son may get to calculus and this curriculum will help him do that," she explained, "because I certainly won't be able to."

**Popular Self-Paced Options Available Through OpenEd:**

[The OpenEd marketplace](https://opened.co/marketplace) offers numerous self-paced curricula including BYU Independent Study, Teaching Textbooks, and specialized programs from providers like OnFire Learning and Knowledge Pillars. Families can browse current options and use their OpenEd funds to access whichever resources best fit their needs.

**Other Strong Self-Paced Programs:**

- [**Khan Academy**](https://www.khanacademy.org/) (Free): Complete K-12 curriculum with practice exercises
- [**Time4Learning**](https://www.time4learning.com/): Automated lessons and grading with parent reports
- [**Power Homeschool**](https://www.powerhomeschool.org/): Adaptive technology that identifies and fills learning gaps
- [**IXL**](https://www.ixl.com/): Skills-based practice that adapts to student level
...
- [**Outschool**](https://outschool.com/): Thousands of live classes on academic and enrichment topics
- [**Varsity Tutors**](https://www.varsitytutors.com/): One-on-one tutoring in any subject
- [**Wiingy**](https://wiingy.com/): Affordable tutoring starting at $19/hour
...
- [**Curiosity Chronicles**](https://curiositychronicles.com/): Conversational history curriculum with scripted dialogues for parent and child.
- [**Math Mammoth**](https://www.mathmammoth.com/): Parent-directed, workbook-style curriculum with scripted explanations.
- [**Beast Academy (by Art of Problem Solving)**](https://beastacademy.com/): Parent-guided comic-style math program, rigorous but very engaging.
- [**Moving Beyond the Page**](https://www.beyondthepage.com/): Project-based, literature-rich curriculum designed to be secular and inquiry-driven. Especially strong for gifted or creative learners.
...
[Claire Honeycutt, a neuroscientist turned homeschool advocate, offers recorded workshops with titles like "You Can Teach Math" and "You Can Teach Reading"](https://www.clarified.life/)—not because you need to master these subjects, but because understanding how children's brains process information can make you more effective.

[Simple K12 ](https://www.simplek12.com/)also provides a flexible membership with 1,000+ short courses on topics relevant to both classroom and home educators. A few examples that stand out for homeschool parents:
...
At [OpenEd](https://opened.co), we've built our entire program around the reality that most parents aren't formally-trained teachers—and don't need to be. Through partnerships with public schools, we provide:
...
*Ready to explore homeschooling with full support? *[*Apply to OpenEd today*](https://opened.co/apply)* or attend a *[*free information session*](https://opened.co/contact-us)*.*
